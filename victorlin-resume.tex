...
\section{LEADERSHIP}
    % \textbf{Multimedia Chair}    \hfill Aug 2016~--~May 2017 \\
    % Society of Asian Scientists and Engineers UF Chapter (\href{http://ufsase.com}{ufsase.com})
    % \begin{itemize}  \itemsep -2pt % reduce space between items
    %     \item Maintained website using WordPress, CSS
    % \end{itemize}

    % \textbf{Vice Principal, Chinese Yo-yo Instructor}    \hfill Aug 2015~--~Present \\
    % Gainesville Chinese School (\href{https://gainesvillechineseschool.com}{gainesvillechineseschool.com})
    % \begin{itemize}  \itemsep -2pt % reduce space between items
    %     \item Created and maintained website using WordPress, CSS, Local by Flywheel
    % \end{itemize}
