...
\section{SKILLS}
    {\sl Languages:} Python, Bash, JavaScript, HTML, CSS/SCSS, Java, C/C++, VB.NET, R, LaTeX \\
    {\sl Frameworks/tools:} Git, make, AngularJS, MongoDB, Bootstrap, Flask, pandas, WordPress
